...
func (c *scannerClient) GetJobPostings(ctx context.Context, in *ScanComplete, opts ...grpc.CallOption) (Scanner_GetJobPostingsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scanner_ServiceDesc.Streams[0], "/careerhub.processor.scanner_grpc.Scanner/GetJobPostings", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *scannerClient) GetSkills(ctx context.Context, in *ScanComplete, opts ...grpc.CallOption) (*Skills, error) {
	out := new(Skills)
	err := c.cc.Invoke(ctx, "/careerhub.processor.scanner_grpc.Scanner/GetSkills", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scannerClient) SetRequiredSkills(ctx context.Context, opts ...grpc.CallOption) (Scanner_SetRequiredSkillsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scanner_ServiceDesc.Streams[1], "/careerhub.processor.scanner_grpc.Scanner/SetRequiredSkills", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *scannerClient) SetScanComplete(ctx context.Context, in *Skills, opts ...grpc.CallOption) (*BoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/careerhub.processor.scanner_grpc.Scanner/SetScanComplete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Scanner_GetSkills_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/careerhub.processor.scanner_grpc.Scanner/GetSkills",
	}
...
func _Scanner_SetScanComplete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/careerhub.processor.scanner_grpc.Scanner/SetScanComplete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Scanner_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "careerhub.processor.scanner_grpc.Scanner",
	...
	Metadata: "careerhub/processor/scanner_grpc/scanner_grpc/grpc.proto",
}
