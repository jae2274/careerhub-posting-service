...
run: build
	@echo "Starting..."
	@env PROVIDER_GRPC_PORT=${PROVIDER_GRPC_PORT} SCANNER_GRPC_PORT=${SCANNER_GRPC_PORT} RESTAPI_GRPC_PORT=${RESTAPI_GRPC_PORT} MONGO_URI=${MONGO_URI} DB_NAME=${DB_NAME} DB_USERNAME=${DB_USERNAME} DB_PASSWORD=${DB_PASSWORD}  ./${BINARY_NAME} 
	@echo "Started!"
...
test:	
	@echo "Testing..."
	@env PROVIDER_GRPC_PORT=${PROVIDER_GRPC_PORT} SCANNER_GRPC_PORT=${SCANNER_GRPC_PORT} RESTAPI_GRPC_PORT=${RESTAPI_GRPC_PORT} MONGO_URI=${MONGO_URI} DB_NAME=${DB_NAME} DB_USERNAME=${DB_USERNAME} DB_PASSWORD=${DB_PASSWORD}  go test -p 1 -timeout 60s ./test/...
