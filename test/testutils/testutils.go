...
func JobPosting(site string, postingId string, categories []string, minCareer *int, maxCareer *int, requiredSkills []jobposting.RequiredSkill, companyName string) *jobposting.JobPostingInfo {
	var min, max *int32
	if minCareer != nil {
